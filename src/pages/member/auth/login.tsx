...
export default function MemberLogin() {
  ...
  const handleLogin = (e: any) => {
    e.preventDefault();
    console.log("Login dengan nomor:", phone);
  };
      ...
      <Card className="w-full max-w-md mx-4 shadow-[0_20px_50px_rgba(0,0,0,0.5)] rounded-none border-none z-10 animate-in fade-in slide-in-from-bottom-8 duration-700 bg-white/95 backdrop-blur-sm">
        <CardBody className="p-8 md:p-12">
          ...
          <form className="flex flex-col gap-6" onSubmit={handleLogin}>
            ...
            <Button
              className="bg-danger text-white font-black py-7 text-lg uppercase tracking-widest hover:bg-[#0B1C39] transition-all group"
              endContent={
